...
const courses = [
  {
    ...
    plan: ["тема вересень", "тема жовтень", "тема листопад", "тема грудень],
  ...
  },
  {
    ...
    features: ["Роботи Makerzoid та Arduino", "Індивідуальний підхід", "Участь у змаганнях"],
  ...
  {
    title: "Math&mind", age: "2-6 клас", price: "Вартість: 1200 грн/місяць",
    ...
    features: ["Підготовка до олімпіад", "Розвиток логіки", "Робочі зошиити"],
    icon: Calculator, color: "border-l-ufo-yellow", iconBg: "bg-ufo-yellow/10", iconColor: "text-ufo-yellow",
  },
  {
    title: "Математика", age: "3-11 клас", price: "Вартість: 1600 грн/місяць",
