...
const team = [
  { name: "Катерина", role: "Викладачка та керівниця освітніх програм", bio: "Вірить, що освіта — це про зростання особистості, свободу мислення й відкриття світу. Проводить заняття так, щоб діти не просто “вчилися”, а пробували, досліджували, ставили запитання й відчували власну гідність", photo: "/kateryna.jpg" },
