...
const team = [
  { name: "Катерина", role: "Засновниця та керівниця", bio: "Понад 10 років у сфері дитячої освіти. Натхненниця всіх наших проєктів та ініціатив.", photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80" },
